...
function App() {
  ...
  return (
    ...
    <main className="container-xl mt-5">
        <h2 className="text-center text-2xl mt-10 font-bold">NEW COLLECTION</h2>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 m-12 gap-22 ">
          {data.map((guitar)=>(
            <Guitar
              key={guitar.id}
              guitar={guitar}
    ...
    <footer className="footer flex-col md:flex-row bg-base-200 text-neutral-content items-center p-4">
